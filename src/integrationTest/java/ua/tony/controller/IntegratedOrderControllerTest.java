...
public class IntegratedOrderControllerTest {
	...
	public void addOrderTest() throws Exception {
		...
		List<OrderDto> orders = orderService.getOrdersWhichRelatedToUser(user.getId());
		mockMvc.perform(
				post("/orders").content(objectMapper.writeValueAsString(orders.get(0))).contentType("application/json"))
	...
	public void shouldReturn404ErrorWhenOrderNotFound() throws Exception {
		...
		mockMvc.perform(get("/orders?order_id=666").accept(MediaType.APPLICATION_JSON))
